...
<td width=20% align=left><font size=2 color=green><b>::班级信息::</b></font></td>
<td width=50% align=center></td>
<td width=30% align=right>
<a href="#" onclick="openScript('add_bj.jsp','sop',600,300);"><font size=2 color=green>添加</font></a>
...
<font size=2 color=green>班级编号</font></td>
<td width=40% align="left" style="border-left:none; border-right:none; border-top:2 solid green; border-bottom:1 solid white">
<font size=2 color=green>班级名称</font></td>
<td width=10% align="left" style="border-left:none; border-right:none; border-top:2 solid green; border-bottom:1 solid white">
...
<td width=10% align="left" style="border-left:none; border-right:none; border-top:none; border-bottom:1 solid white">
<a href="#" onclick="openScript('bj_modify.jsp?id=<%=bk.getId() %>','sop',600,300);"><font size=2 color=green>编辑</font></a></td>
</tr>
<%}
}
} else {%>
...
<table align="center" width="778" border="0" cellspacing="0" cellpadding="0"  bgcolor="#E4EDFB">
<tr bgcolor="#DEF3CE">
 <td width="50%" align="left" ><font size=2 color=green>&nbsp提示:<%=mesg%>共<%= bj.getrecordCount()%>条记录</font></td>
<td width="50%" align="right"><font size=2 color=green>共<%= bj.getPageCount() %>页&nbsp;当前页第<%= bj.getPage() %>页　
<a href="bj.jsp">首页</a>&nbsp;
<% if (bj.getPage()>1) {%>
<a href="bj.jsp?page=<%= bj.getPage()-1 %>">上一页</a>&nbsp;<% }else{ %>上一页&nbsp;<%}%>
<% if (bj.getPage()<bj.getPageCount()-1) {%>
<a href="bj.jsp?page=<%= bj.getPage()+1 %>">下一页</a>&nbsp;<% }else{ %>下一页&nbsp;<%}%>
<a href="bj.jsp?page=<%= bj.getPageCount() %>">未页</a>&nbsp;</font></td>
</tr>
</table>
<%}%>
</center>
